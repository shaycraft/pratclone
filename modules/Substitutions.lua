...
["Are you sure?"] = true,
["can't find substitution index for a substitution named '%s'"] = true,
["Current value: '%s'.  Click to paste into the chat."] = true,
["defined %s: expands to => %s"] = true,
["Delete all"] = true,
["Delete substitution"] = true,
["Deletes a user defined substitution"] = true,
...
["Current value: '%s'.  Click to paste into the chat."] = "Valeur actuelle : '%s'.  Cliquez pour coller dans le chat.",
...
["Current value: '%s'.  Click to paste into the chat."] = "Gegenwärtiger Wert: '%s'.  Anklicken, um in den Chat einzufügen.",
...
["PlayerAverageItemLevel"] = "[Durchschnittliche Gegenstandsstufe des Spielers Ersatz]",
...
["Current value: '%s'.  Click to paste into the chat."] ="현재 값: '%s'.  클릭하면 대화창에 붙여 넣습니다.",
...
["Current value: '%s'.  Click to paste into the chat."] = "Текущее значение: '%s'.  Кликнуть для копирования в чат.",
...
["Current value: '%s'.  Click to paste into the chat."] = "当前值: '%s'Click to paste into the chat.",
...
["Current value: '%s'.  Click to paste into the chat."] = "Valor actual: '%s'.  Click para pegar en el chat.",
...
["Are you sure?"] = "你確定嗎？",
["Current value: '%s'.  Click to paste into the chat."] = "當前值：%s.  點擊以在聊天視窗中貼上",
